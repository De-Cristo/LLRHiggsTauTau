...
datasetsFile = "datasets_test_Licheng_private.txt"
tag = "MC_2018_10Mar2023_DY_JM"
isMC = True

PROCESS = [
    "SIGNALS_DY_JM_2018",
    # "SIGNALS_GF_LO_SM_2018",
    # "BACKGROUNDS_TT_2018",
    # "BACKGROUNDS_DY_2018",
    # "BACKGROUNDS_H_2018"
...
#        shortName = shortName[toRemove:]
    ...
    command = "crab submit -c crab3_template_Licheng.py"
    ...
    # command += " Data.outLFNDirBase=/store/user/lichengz/patch_BSMKls/%s/%s" % (tag , str(counter)+"_"+dtsetNames) # change to where you want to stage you ntuples
    command += " Data.outLFNDirBase=/store/user/lichengz/DY_JM_ck/%s" % (tag)
